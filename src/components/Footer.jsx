    ...
    <footer className="bg-blue-50 mt-10 py-10">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-6 text-gray-700">
        ...
        <div>
          ...
          <ul className="text-sm mt-2 space-y-1"><li>Login</li><li>Register</li><li>Orders</li></ul>
        </div>
